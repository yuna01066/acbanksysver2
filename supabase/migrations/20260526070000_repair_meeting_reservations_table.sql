-- Repair meeting reservation objects when a remote database missed the original migration
-- or has stale PostgREST schema cache state.
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Authenticated users can read meeting reservations'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Users can create meeting reservations'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Creators can update their meeting reservations'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Creators can delete their meeting reservations'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Admins can manage meeting reservations'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Moderators can manage meeting reservations'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'meeting_reservations'
      AND policyname = 'Managers can manage meeting reservations'
  ) THEN
