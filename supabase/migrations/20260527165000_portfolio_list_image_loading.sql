-- Split portfolio list loading from full project image loading.
...
AS $$
  ...
  SELECT
    ...
    ranked.drive_folder_id,
    ranked.drive_path,
    ranked.file_name,
    ranked.caption,
    ranked.width,
    ranked.height,
    ranked.dominant_color,
    ranked.taken_at,
    ranked.thumbnail_url,
    ranked.image_url,
    ranked.thumbnail_bucket,
    ranked.thumbnail_path,
    ranked.thumbnail_width,
    ranked.thumbnail_height,
