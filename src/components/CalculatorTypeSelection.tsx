...
import { Calculator, TrendingUp, Film } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        ...
        <Button
          variant="outline"
          className="h-32 flex-col gap-4 text-lg font-semibold transition-all duration-200 rounded-lg border-2 hover:border-purple-500 hover:bg-purple-50"
          onClick={() => navigate('/film-acrylic-calculator')}
        >
          <Film className="w-8 h-8 text-purple-600" />
          <div className="text-center">
            <div className="font-semibold text-gray-900">필름 아크릴</div>
            <div className="text-sm text-gray-600 mt-1">필름 아크릴 견적</div>
          </div>
        </Button>
      </div>
    </div>
