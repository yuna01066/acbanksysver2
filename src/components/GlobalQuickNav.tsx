...
const QUICK_NAV_ITEMS: QuickNavItem[] = [
  ...
  { title: '재고·주문 센터', description: '아임웹 주문과 재고 통합 운영', path: '/inventory-ops', group: '업무', keywords: '재고 주문 아임웹 상품 샘플칩 inventory order imweb', icon: PackageCheck, adminOnly: true },
  ...
  { title: '통합 캘린더', description: '개인·팀·회의실 일정', path: '/calendar', group: '업무', keywords: '캘린더 일정 회의실 calendar schedule room', icon: CalendarDays },
