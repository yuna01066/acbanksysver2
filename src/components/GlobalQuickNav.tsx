...
const QUICK_NAV_ITEMS: QuickNavItem[] = [
  ...
  { title: '채널톡 문의 분석함', description: '도면 분석 리드 검토/전환', path: '/channel-talk-leads', group: '관리', keywords: '채널톡 문의 도면 분석 channel talk lead drawing', icon: MessageSquareText, adminOnly: true },
