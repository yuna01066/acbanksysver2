...
const EditableQuoteItem = ({ item, index, onUpdate, onRemove, quoteId }: EditableQuoteItemProps) => {
  ...
  const handleEditInCalculator = () => {
    ...
    const quoteParams = new URLSearchParams({
      ...
      selectedColor: editedItem.selectedColor || '',
      selectedColorHex: editedItem.selectedColorHex || '',
      customColorName: editedItem.customColorName || '',
      customOpacity: editedItem.customOpacity || '',
