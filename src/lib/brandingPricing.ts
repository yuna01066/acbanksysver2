...
export const brandingPackages = {
  basic: {
    ...
    name: '브랜드 기본형',
    price: 220,
    summary: '브랜드의 기본 방향과 핵심 시각 기준을 정리합니다.',
    includes: ['레퍼런스 무드', '키 컬러/서브 컬러', '폰트 방향', '로고·심볼 기본 가이드', '브랜드 가이드 문서'],
  },
  standard: {
    id: 'standard',
    name: '브랜드 런칭형',
    price: 440,
    summary: '오픈 전 필요한 브랜드 표현과 기본 응대 문구까지 정리합니다.',
    includes: ['기본형 포함', '네이밍/슬로건 방향', '브랜드 스토리', '기본 소개 문구', '사인 방향 1종'],
  },
  open: {
    id: 'open',
    name: '브랜드 오픈형',
    price: 880,
    summary: '오픈 준비에 필요한 디자인 방향과 제작 전달 자료를 함께 구성합니다.',
    includes: ['런칭형 포함', '홈페이지 3p 디자인 방향', 'AI 이미지 5컷', '홍보물 2종', '제작 전달 기본안'],
  },
} as const;
