      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <Card className="shadow-lg border-0 rounded-xl overflow-hidden bg-white">
          ...
          <CardContent className="p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {quoteData.factory && (
                  <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="text-sm text-gray-600 mb-1">공장</div>
                    <div className="font-semibold text-gray-900">{quoteData.factory}</div>
                  </div>
                )}
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            {/* 가격 상세 내역 */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-6">가격 상세 내역</h3>
